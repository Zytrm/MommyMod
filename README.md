...
- **FishingPartyHelper** — checks Fishing 45, Silver Trophy Hunter, Looting V, Bloodshot belt, and Jawbus eligibility.
- **MM Party** — adds a compact `J`, `L5`, and `BS` readiness block to the Hypixel sidebar with a manual refresh action in the ClickGUI.
